...
namespace Shiro {
ActionOptionData::ActionOptionData() : action(nullptr), val(0) {}

GameMultiOptionData::GameMultiOptionData() : mode(0), num(0), selection(0), args(nullptr) {}

GameArguments::GameArguments() : num(0), ptrs(nullptr) {}

GameOptionData::GameOptionData() : mode(0) {}

MetaGameOptionData::MetaGameOptionData() : mode(0), submode(0), num_args(0), num_subargs(0), args(nullptr), sub_args(nullptr) {}

MultiOptionData::MultiOptionData() : selection(0), num(0), param(nullptr), vals(nullptr) {}

TextOptionData::TextOptionData() : active(0), position(0), selection(0), leftmost_position(0), visible_chars(0) {}

ToggleOptionData::ToggleOptionData() : param(nullptr), labels{"", ""} {}
