...
class ScreenManager
{
  public:
    ...
    void addScreen(std::string name, GUIScreen *screen) { screens[name] = screen; }

    GUIScreen *getCurrentScreen() { return currentScreen; }
...
{
  public:
    GUIScreenSwitchButton(int ID, std::string screenName, ScreenManager *mngr, std::string displayString, BitFont &font, SDL_FRect relativeDestRect)
